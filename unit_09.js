...
function f6() {
  document.querySelector(".out-6").textContent =
    document.querySelectorAll(".p-6").length;
}
...
function f7() {
  let divs = document.querySelectorAll(".out-7");
  for (let i = 0; i < divs.length; i++) {
    divs[i].classList.add("bg-orange");
  }
}
...
function f8() {
  let divs = document.querySelectorAll(".out-8");
  for (let i = 0; i < divs.length; i++) {
    divs[i].classList.toggle("bg-orange");
  }
}
...
function f11() {
  ...
  let div = (document.createElement("div").innerHTML = 25);
  out11.append(div);
}
...
function f18() {
  ...
  document.querySelector(".out-18").textContent = p.getAttribute("data-b");
}
